...
struct MainAutoLoggedInView: View {
...
struct MainAutoLoggedInView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        MainAutoLoggedInView(selectedGoal: $selectedGoal, lowerGoal: $lowerGoal, upperGoal: $upperGoal, isLoggedIn: $isLoggedIn, username: $username).environmentObject(PostsManager())
    }
}
